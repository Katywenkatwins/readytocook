(() => {
    ...
    function initSliders() {
        if (document.querySelector(".our-menu__slider")) new core(".our-menu__slider", {
        ...
        if (document.querySelector(".our-menu-images__slider")) new core(".our-menu-images__slider", {
